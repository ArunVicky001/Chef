...
//  OTPSample
//
//  Created by Bhagyashree Myanamwar on 9/29/21.
//
...
@objc public class OTPFieldView: UIView {
    ...
    public var separatorSpace: CGFloat = 6
...
extension OTPFieldView: UITextFieldDelegate {
    ...
    public func textFieldDidEndEditing(_ textField: UITextField) {
        if displayType == .diamond || displayType == .underlinedBottom {
            (textField as! OTPTextField).shapeLayer.fillColor = defaultBorderColor.cgColor
